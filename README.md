...
1. Import the application ![Project File] (https://github.com/AMUGADDAHEMANTHKUMAR/Pega-RapidoProject/blob/main/PegaRapidoProjectFile.zip) file via **Designer Studio → Application → Distribution → Import**  
